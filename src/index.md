...
features:
  - icon: 🎯
    title: 成绩与玩家
    details: 查询最好、最近和最近通过成绩，查看玩家资料、成绩详情及成绩分析。
  - icon: 🗺️
    title: 谱面与搜索
...
Seira 依赖 [oStella](https://github.com/BotSeira/oStella) 提供 osu! 数据与渲染服务。文档适用于 SeiraCore `1.11.2` 版本，更新可能会有延后~
